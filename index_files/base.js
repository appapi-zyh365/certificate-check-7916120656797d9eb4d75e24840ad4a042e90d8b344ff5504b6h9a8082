...
function initUrl(uri, data) {
  ...
  var newUrl =
    url.indexOf('appapi.zyh365.com') != -1
      ...
      ? BASE_URL_LOCAL
      : url.indexOf('39.107.139.191') != -1
      ? BASE_URL_DEV
      : ''
      if (data.method_id != undefined && data.method_id != 'undefined' && data.method_id != null && data.method_id != 'null' && data.method_id != '') {
        return newUrl + uri + '?app_id=h5&method_id=' + data.method_id
      } else {
